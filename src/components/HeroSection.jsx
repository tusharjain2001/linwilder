...
export default function HeroSection() {
  return (
    <section className="relative w-full min-h-[857px] overflow-hidden">
      {/* Background */}
      <img
        src={heroBg}
        alt=""
        ...
        <div className="flex flex-col gap-14 flex-1 max-w-[690px]">
          ...
          <div className="flex flex-col gap-3 items-center text-center">
            <p className="font-['Sedan_SC'] text-[#f6efe9] text-2xl leading-8">
              An Award-winning<br />Dr. Lindsey McCall medical mystery series.
            </p>
            <div className="flex gap-5 items-center mt-2">
              <img src={award1} alt="Award 1" className="w-[105px] h-[105px] object-contain" />
              <img src={award2} alt="Award 2" className="w-[100px] h-[100px] object-contain" />
              <img src={award3} alt="Award 3" className="w-[109px] h-[109px] object-contain" />
            </div>
          </div>
          ...
          <div className="flex flex-col gap-11 items-center w-full">
            <div className="text-[#f6efe9] text-center w-full">
              <h2 className="font-['Aboreto'] text-[52px] leading-[72px]">Plausible Liars.</h2>
              <p className="font-['Questrial'] text-xl leading-8">
                In Lin Wilder's fifth Lindsey McCall mystery, journalist Kate Townsend's
                controversial series on gender politics and children leads to a legal battle,
                drawing Dr. Lindsey McCall into a conspiracy involving transgender issues and
                medical ethics.
              </p>
            </div>
